...
void UMyFirstGameLiftGameInstance::Init() {
	Super::Init();

	GetWorld()->GetTimerManager().SetTimer(GetResponseTimeHandle, this, &UMyFirstGameLiftGameInstance::GetResponseTime, 1.0f, true, 1.0f);
}
...
void UMyFirstGameLiftGameInstance::SetCognitoTokens(FString NewAccessToken, FString NewIdToken, FString NewRefreshToken) {
	...
	GetWorld()->GetTimerManager().SetTimer(RetrieveNewTokensHandle, this, &UMyFirstGameLiftGameInstance::RetrieveNewTokens, 1.0f, false, 3300.0f);
}
...
void UMyFirstGameLiftGameInstance::GetResponseTime() {
	TSharedRef<IHttpRequest, ESPMode::ThreadSafe> GetResponseTimeRequest = HttpModule->CreateRequest();
	GetResponseTimeRequest->OnProcessRequestComplete().BindUObject(this, &UMyFirstGameLiftGameInstance::OnGetResponseTimeResponseReceived);
...
void UMyFirstGameLiftGameInstance::OnGetResponseTimeResponseReceived(FHttpRequestPtr Request, FHttpResponsePtr Response, bool bWasSuccessful) {
